...
export default function SecOne() {
    return (
        <>
            <section className="w-full py-24 md:py-24 lg:py-42 xl:py-52" id="welcome">
                <div className="px-4 md:px-6 lg:px-8 xl:px-10">
                    <div
                        ...
                        <img
                            alt="Hero"
                            className="mx-auto drop-shadow-xl aspect-video overflow-hidden rounded-xl object-cover sm:w-full lg:order-last lg:aspect-square xl:rounded-2xl z-10"
                            height="550"
                            src="/library.svg"
                            width="550"
                        />
